...
{
    /// <summary>
    /// Logica di interazione per SmallWindow.xaml
    /// </summary>
    public partial class SmallWindow : Window
    {
        ...
        public SmallWindow(NotifyIcon ni)
        {
        ...
        public void NotifyIconClick(object sender, System.Windows.Forms.MouseEventArgs args)
        {
            if (!this.IsLoaded)
                this.Show();
